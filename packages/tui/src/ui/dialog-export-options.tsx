    ...
    <box paddingLeft={2} paddingRight={2} gap={1}>
      ...
      <Show when={store.active !== "filename"}>
        <text fg={theme.textMuted} paddingBottom={1}>
          {t("export.press")} <span style={{ fg: theme.text }}>space</span> {t("export.toToggle")} {" "}
          <span style={{ fg: theme.text }}>return</span> {t("export.toConfirm")}
        </text>
      </Show>
      <Show when={store.active === "filename"}>
        <text fg={theme.textMuted} paddingBottom={1}>
          {t("export.press")} <span style={{ fg: theme.text }}>return</span> {t("export.toConfirm")}, {" "}
          <span style={{ fg: theme.text }}>tab</span> {t("export.forOptions")}
        </text>
      </Show>
    </box>
  )
