...
export const dict: Dict = {
  ...
  "autolychee.title": "Auto bookkeeping (Lychee Ledger)",
  "autolychee.status": "Status:",
  "autolychee.statusOn": "Enabled",
  "autolychee.statusOff": "Disabled",
  "autolychee.key": "API Key:",
  "autolychee.keySet": "Configured (…{prefix})",
  "autolychee.keyMissing": "Not configured",
  "autolychee.keyHint": "Generate a key at Lychee Ledger「Settings → API access key」, then copy it and click paste.",
  "autolychee.desc": "When enabled, each session cost is recorded to lycheeledger.cn on exit.",
  "autolychee.enable": "Enable",
