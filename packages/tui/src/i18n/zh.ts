...
export const dict: Dict = {
  ...
  "autolychee.title": "自动记账(荔枝账本)",
  "autolychee.status": "状态:",
  "autolychee.statusOn": "已开启",
  "autolychee.statusOff": "已关闭",
  "autolychee.key": "API Key:",
  "autolychee.keySet": "已配置(…{prefix})",
  "autolychee.keyMissing": "未配置",
  "autolychee.keyHint": "请到荔枝记账「设置 → API 访问密钥」生成 Key, 复制后点击下面的按钮粘贴保存。",
  "autolychee.desc": "开启后, 每次会话结束自动把本次 AI 成本记录到荔枝账本。",
  "autolychee.enable": "开启",
